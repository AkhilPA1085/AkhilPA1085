# 💫 About Me:
Passionate and results-driven Frontend Developer with over two years of experience in building scalable and performance-optimized web applications. <br>Proficient in Next.js, React.js, Redux, Tailwind CSS, HTML5, CSS3, JavaScript(ES6+), and Ajax.<br>Adept at creating user-friendly interfaces, collaborating on API integrations, and delivering responsive designs across various platforms. <br>Skilled in optimizing website performance, ensuring high usability, and maintaining mobile-friendly, dynamic websites.
